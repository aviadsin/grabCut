...
def parse():
    ...
    parser.add_argument('--src_path', type=str, default='./data/imgs/sheep.jpg', help='image file path')
    parser.add_argument('--mask_path', type=str, default='./data/seg_GT/sheep.bmp', help='mask file path')
